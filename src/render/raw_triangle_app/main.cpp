...
class RawVulkanTriangleApp {
  ...
  private:
	...
	void pickPhysicalDevice() {
		...
		if (physicalDevice == VK_NULL_HANDLE) {
			throw std::runtime_error(
				"failed to find a suitable GPU with Dynamic Rendering (Vulkan 1.3)!");
		}
	}
	...
	void recordCommandBuffer(VkCommandBuffer cmdBuffer, uint32_t imageIdx) {
		...
		colorAttachment.clearValue.color = {0.08f, 0.09f, 0.12f,
											1.0f}; // Matches the Zahlen background dark theme!
