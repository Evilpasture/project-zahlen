...
// src/render/SMAALUTGenerator.hpp
...
struct SmaaVec2 {
    ...
    constexpr SmaaVec2 operator+(const SmaaVec2& o) const noexcept {
        return {x + o.x, y + o.y};
    }
    constexpr SmaaVec2 operator-(const SmaaVec2& o) const noexcept {
        return {x - o.x, y - o.y};
    }
    constexpr SmaaVec2 operator*(float s) const noexcept {
        return {x * s, y * s};
    }
    constexpr SmaaVec2 operator/(float s) const noexcept {
        return {x / s, y / s};
    }
    [[nodiscard]] SmaaVec2 Sqrt() const noexcept {
...
inline std::pair<float, float> AreaOrthoInternal(SmaaVec2 p1, SmaaVec2 p2, float x) noexcept {
    ...
    if (inside) {
        ...
        return (a < 0.0f) ? std::pair {std::abs(a1), std::abs(a2)} : std::pair {std::abs(a2), std::abs(a1)};
    }
    return {0.0f, 0.0f};
}

inline std::pair<float, float> AreaOrtho(int pattern, float left, float right, float offset) noexcept {
    ...
    switch (pattern) {
        ...
        case 3: {
            ...
            auto smoothed = SmoothArea(d, {a1_pair.first, a1_pair.second}, {a2_pair.first, a2_pair.second});
...
inline SmaaVec2 AreaDiagHelper(int pattern, SmaaVec2 p1, SmaaVec2 p2, float left, SmaaVec2 offset) noexcept {
...
inline SmaaVec2 AreaDiag(int pattern, float left, float right, SmaaVec2 offset) noexcept {
    ...
    switch (pattern) {
        case 0: {
            SmaaVec2 a1 = AreaDiagHelper(pattern, SmaaVec2(1.0f, 1.0f), SmaaVec2(1.0f + d, 1.0f + d), left, offset);
            SmaaVec2 a2 = AreaDiagHelper(pattern, SmaaVec2(1.0f, 0.0f), SmaaVec2(1.0f + d, d), left, offset);
            return (a1 + a2) * 0.5f;
        }
        case 1: {
            SmaaVec2 a1 = AreaDiagHelper(pattern, SmaaVec2(1.0f, 0.0f), SmaaVec2(d, d), left, offset);
            SmaaVec2 a2 = AreaDiagHelper(pattern, SmaaVec2(1.0f, 0.0f), SmaaVec2(1.0f + d, d), left, offset);
            return (a1 + a2) * 0.5f;
        }
        case 2: {
            SmaaVec2 a1 = AreaDiagHelper(pattern, SmaaVec2(0.0f, 0.0f), SmaaVec2(1.0f + d, d), left, offset);
            SmaaVec2 a2 = AreaDiagHelper(pattern, SmaaVec2(1.0f, 0.0f), SmaaVec2(1.0f + d, d), left, offset);
            return (a1 + a2) * 0.5f;
        }
        case 3:
            return AreaDiagHelper(pattern, SmaaVec2(1.0f, 0.0f), SmaaVec2(1.0f + d, d), left, offset);
        case 4: {
            SmaaVec2 a1 = AreaDiagHelper(pattern, SmaaVec2(1.0f, 1.0f), SmaaVec2(d, d), left, offset);
            SmaaVec2 a2 = AreaDiagHelper(pattern, SmaaVec2(1.0f, 1.0f), SmaaVec2(1.0f + d, d), left, offset);
            return (a1 + a2) * 0.5f;
        }
        case 5: {
            SmaaVec2 a1 = AreaDiagHelper(pattern, SmaaVec2(1.0f, 1.0f), SmaaVec2(d, d), left, offset);
        ...
        case 6:
            return AreaDiagHelper(pattern, SmaaVec2(1.0f, 1.0f), SmaaVec2(1.0f + d, d), left, offset);
        case 7: {
            SmaaVec2 a1 = AreaDiagHelper(pattern, SmaaVec2(1.0f, 1.0f), SmaaVec2(1.0f + d, d), left, offset);
            SmaaVec2 a2 = AreaDiagHelper(pattern, SmaaVec2(1.0f, 0.0f), SmaaVec2(1.0f + d, d), left, offset);
            return (a1 + a2) * 0.5f;
        }
        case 8: {
            SmaaVec2 a1 = AreaDiagHelper(pattern, SmaaVec2(0.0f, 0.0f), SmaaVec2(1.0f + d, 1.0f + d), left, offset);
            SmaaVec2 a2 = AreaDiagHelper(pattern, SmaaVec2(1.0f, 0.0f), SmaaVec2(1.0f + d, 1.0f + d), left, offset);
            return (a1 + a2) * 0.5f;
        }
        case 9:
            return AreaDiagHelper(pattern, SmaaVec2(1.0f, 0.0f), SmaaVec2(1.0f + d, 1.0f + d), left, offset);
        case 10: {
            SmaaVec2 a1 = AreaDiagHelper(pattern, SmaaVec2(0.0f, 0.0f), SmaaVec2(1.0f + d, 1.0f + d), left, offset);
            SmaaVec2 a2 = AreaDiagHelper(pattern, SmaaVec2(1.0f, 0.0f), SmaaVec2(1.0f + d, d), left, offset);
            return (a1 + a2) * 0.5f;
        ...
        case 11: {
            SmaaVec2 a1 = AreaDiagHelper(pattern, SmaaVec2(1.0f, 0.0f), SmaaVec2(1.0f + d, 1.0f + d), left, offset);
            SmaaVec2 a2 = AreaDiagHelper(pattern, SmaaVec2(1.0f, 0.0f), SmaaVec2(1.0f + d, d), left, offset);
            return (a1 + a2) * 0.5f;
        }
        case 12:
            return AreaDiagHelper(pattern, SmaaVec2(1.0f, 1.0f), SmaaVec2(1.0f + d, 1.0f + d), left, offset);
        case 13: {
            SmaaVec2 a1 = AreaDiagHelper(pattern, SmaaVec2(1.0f, 1.0f), SmaaVec2(1.0f + d, 1.0f + d), left, offset);
            SmaaVec2 a2 = AreaDiagHelper(pattern, SmaaVec2(1.0f, 0.0f), SmaaVec2(1.0f + d, 1.0f + d), left, offset);
            return (a1 + a2) * 0.5f;
...
inline void FillSmaaAreaTex(std::span<uint32_t> outPixels) noexcept {
    ...
    constexpr SmaaVec2 diagOffsets[5]  = {{0.00f, 0.00f}, {0.25f, -0.25f}, {-0.25f, 0.25f}, {0.125f, -0.125f}, {-0.125f, 0.125f}};

    static constexpr std::pair<int, int> edgesortho[16] = {{0, 0}, {3, 0}, {0, 3}, {3, 3}, {1, 0}, {4, 0}, {1, 3}, {4, 3},
...
inline void FillSmaaSearchTex(std::span<uint32_t> outPixels) noexcept {
    ...
    auto deltaLeft = [](const std::array<int, 4>& left, const std::array<int, 4>& top) noexcept -> int {
        int d = 0;
        if (top[3] == 1) {
            d += 1;
        }
    ...
    auto deltaRight = [](const std::array<int, 4>& left, const std::array<int, 4>& top) noexcept -> int {
        int d = 0;
