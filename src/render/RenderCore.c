...
static VkBool32 VKAPI_CALL ZHLN_Internal_DebugCallback(
    ...
    if (data->pMessageIdName && strcmp(data->pMessageIdName, "UNASSIGNED-GPU-Assisted-Validation") == 0) {
...
VkInstance ZHLN_CreateInstance(const ZHLN_InstanceDesc* restrict desc) {
    ...
    available_count = ZHLN_Min(available_count, maxInstanceExtensions); // safe clamp for stack-only allocation
