...
void StagingContext::UploadImage2DBuffer(VkImage dstImage, uint32_t w, uint32_t h,
										 uint32_t mipLevels, VkBuffer stagingBuf,
										 VkDeviceSize offset) {
...
void StagingContext::UploadPrefilteredCubeMap(VkImage dstImage, VkBuffer stagingBuf,
