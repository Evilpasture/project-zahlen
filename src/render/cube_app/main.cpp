...
int main() {
    ...
    ZHLN_BufferImageCopyDesc copyDesc = {
        .buffer = stagingBuffer.Handle(), .image = cube_texture_image.Handle(), .layout = VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, .width = TEX_W, .height = TEX_H
    };
    ...
    ZHLN_PipelineLayoutDesc  layout_desc = {.set_layouts = &rawLayout, .set_layout_count = 1, .push_constants = &push_range, .push_constant_count = 1};
