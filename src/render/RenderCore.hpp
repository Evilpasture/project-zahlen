...
// ============================================================================
// Render Subsystem Errors (Tier 2)
// Shared across the renderer's internal translation units. The public
// Render.hpp API only ever surfaces the type-erased ZHLN::Error wrapper, so
// these categories stay out of shipped headers.
// ============================================================================
