...
#embed SHADER_SMAA_EDGE_SLANG_VS_PATH
};
constexpr uint8_t smaa_edge_ps_raw[] = {
#embed SHADER_SMAA_EDGE_SLANG_PS_PATH
};
...
#embed SHADER_SMAA_WEIGHT_SLANG_VS_PATH
};
constexpr uint8_t smaa_weight_ps_raw[] = {
#embed SHADER_SMAA_WEIGHT_SLANG_PS_PATH
};
...
#embed SHADER_SMAA_BLEND_SLANG_VS_PATH
};
constexpr uint8_t smaa_blend_ps_raw[] = {
#embed SHADER_SMAA_BLEND_SLANG_PS_PATH
};
...
#embed SHADER_VOLUMETRIC_FOG_INJECT_SLANG_CS_PATH
};
...
#embed SHADER_VOLUMETRIC_LIGHT_INJECT_SLANG_CS_PATH
};
...
#embed SHADER_VOLUMETRIC_TEMPORAL_SLANG_CS_PATH
};
...
#embed SHADER_PARTICLE_UPDATE_SLANG_CS_PATH
};
...
#embed SHADER_PARTICLE_RENDER_SLANG_VS_PATH
};
constexpr uint8_t particle_render_ps_raw[] = {
#embed SHADER_PARTICLE_RENDER_SLANG_PS_PATH
};
...
#embed SHADER_DECAL_SLANG_VS_PATH
};
constexpr uint8_t decal_ps_raw[] = {
#embed SHADER_DECAL_SLANG_PS_PATH
};
...
#embed SHADER_MESH_PARTICLE_UPDATE_SLANG_CS_PATH
};
...
#embed SHADER_MESH_PARTICLE_RENDER_SLANG_VS_PATH
};
constexpr uint8_t mesh_particle_render_ps_raw[] = {
#embed SHADER_MESH_PARTICLE_RENDER_SLANG_PS_PATH
};
...
#embed SHADER_MESH_PARTICLE_SHADOW_SLANG_VS_PATH
};
constexpr uint8_t mesh_particle_shadow_ps_raw[] = {
#embed SHADER_MESH_PARTICLE_SHADOW_SLANG_PS_PATH
};
...
#embed SHADER_CLUSTER_BOUNDS_SLANG_CS_PATH
};

constexpr uint8_t cluster_culling_raw[] = {
#embed SHADER_CLUSTER_CULLING_SLANG_CS_PATH
};
