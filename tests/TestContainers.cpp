...
enum class CoreContainersTestError : uint32_t {
    MemoryLeakDetected[[= ZHLN::Description<"Resource lifetime mismatch: active memory leak detected.">{}]] = 1,
    ArrayInvariantFailed[[= ZHLN::Description<"Array operation violated container invariants.">{}]],
    HashMapInvariantFailed[[= ZHLN::Description<"HashMap failed retrieval, tombstone, or resizing test.">{}]],
    ObjectPoolFailed[[= ZHLN::Description<"ObjectPool slot recycling or chunk growth failed.">{}]],
    QueueOrderFailed[[= ZHLN::Description<"Queue FIFO ordering or concurrent popping failed.">{}]],
    SkipListInvariantFailed[[= ZHLN::Description<"SkipList ordering or concurrent GC failed.">{}]],
    RadixSortFailed[[= ZHLN::Description<"RadixSort64 produced unsorted or corrupted output.">{}]],
    FixedStringFailed[[= ZHLN::Description<"FixedString capacity truncation or manipulation failed.">{}]],
    AtomicInvariantFailed[[= ZHLN::Description<"Atomic POD operations returned incorrect values.">{}]],
    RangesPipelineFailed[[= ZHLN::Description<"Ranges combinator returned unexpected output.">{}]],
    LoopUnrollFailed[[= ZHLN::Description<"Compile-time loop unrolling failed to execute exact iteration count.">{}]]
};
