...
enum class ExplosionTestError : uint32_t {
    ExplosionSpawnFailed[[= ZHLN::Description<"ExplosionSystem::Spawn failed to instantiate entity hierarchy.">{}]] = 1,
    CraterDecalSpawnFailed[[= ZHLN::Description<"Autonomous crater decal was not spawned after ground impact delay.">{}]],
    CraterFadeFailed[[= ZHLN::Description<"Crater decal did not dissolve/scale down during the fade window.">{}]],
    EntityLeakDetected[[= ZHLN::Description<"Explosion root or debris entities remained alive after duration expired.">{}]],
};
