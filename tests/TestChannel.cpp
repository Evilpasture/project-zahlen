...
enum class ChannelTestError : uint32_t {
    FifoOrderingViolated[[= ZHLN::Description<"Channel popped messages out of chronological order.">{}]] = 1,
    MessageLost[[= ZHLN::Description<"One or more messages were dropped during channel push/pop.">{}]],
};
...
int main() {
    return ZHLN::Test::Runner::Run<ChannelTestSuite>();
}
