...
template <> struct CustomFormatter<ZHLN::Entity> {
...
template <> struct CustomFormatter<JPH::Vec3> {
...
template <> struct CustomFormatter<JPH::DVec3> {
...
template <> struct CustomFormatter<JPH::Quat> {
