...
on the live editor `RenderContext` (`Engine::AddWindow` creates the extra
swapchain; `PresentUI` presents it): same device, a second `VkSwapchainKHR`,
no second Engine and no skip-init child.
