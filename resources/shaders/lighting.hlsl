...
#ifndef DISABLE_RTR
            if (ENABLE_RTR != 0 && pc.enableRTR != 0) {
                float3 L_center     = ((light.points[0].xyz + light.points[1].xyz + light.points[2].xyz + light.points[3].xyz) * 0.25f) - worldPos;
